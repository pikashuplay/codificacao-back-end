...
3. Implementação da busca por ID
...
4. Tratamento de livro não encontrado
...
7. Comunicação entre Controller e Service
...
Busca o livro pelo ID
      ↓
Retorna o livro
8. Configuração do app.module.ts
...
Organização entre Controller e Service;
Configuração de Controllers e Providers no AppModule.

11. ### 🛠️ Passos Realizados:

1. **Criação da Regra de Negócio no Service (`livros.service.ts`):**
...
2. **Configuração de Rotas no Controller (`app.controller.ts` e `livros.controller.ts`):**
